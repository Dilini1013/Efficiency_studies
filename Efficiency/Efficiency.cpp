...
void Efficiency(){
    ...
    TFile *AnaFile = new TFile("efficiency.root", "RECREATE", "Test");
    ...
    TChain fake("hipo");
      fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_0050*.hipo");
   /* fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_00511*.hipo");
    fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_00512*.hipo");
    fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_00513*.hipo");
    fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_00514*.hipo");
    fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_00515*.hipo");
    fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_00516*.hipo");
    fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_00517*.hipo");
    fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_00518*.hipo");
    //fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_00511*.hipo");
    fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_005190.hipo");
    fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_005191.hipo");
    fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_005193.hipo");
    fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_005194.hipo");
    fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_005195.hipo");
    fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_005196.hipo");
    // fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_005197.hipo");
    //fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_00511*.hipo");
    //fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_00512*.hipo");
    //  fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_005124.hipo");
    //   fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_005125.hipo");
    //  fake.Add("/w/hallb-scifs17exp/clas12/rg-a/montecarlo/fall2018/torus-1/clasdis/bg/45nA_Job_*");
    //  fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_00504*.hipo");
    // fake.Add("/lustre19/expphy/volatile/clas12/dilinib/SIDIS/MC_testing/Backgroung_merging/skim*");
    //  fake.Add("/w/hallb-scifs17exp/clas12/rg-a/montecarlo/fall2018/torus-1/clasdis/bg/45nA_Job_2183.hipo");
    //     fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_00530*.hipo");
    //   fake.Add("/cache/clas12/rg-a/production/recon/fall2018/torus-1/pass1/v0/dst/train/skim4/skim4_00531*.hipo");
    //   fake.Add("/volatile/clas12/dilinib/SIDIS/MC_testing/Background_merging/skim_*");
    //  fake.Add("/lustre19/expphy/volatile/clas12/dilinib/SIDIS/MC_testing/Background_merge/skim_*");
    //  fake.Add("/lustre19/expphy/volatile/clas12/dilinib/SIDIS/MC_testing/skim_DIS_pass1_689_692.hipo");
    //  fake.Add("/w/hallb-scifs17exp/clas12/dilinib/SIDIS_exclusive/Background_meging/skim_45nA_Job_2183.hipo");
    //  fake.Add("/work/clas12/dilinib/SIDIS_exclusive/MC_testing/skim_DIS_pass1_1003_1008.hipo");
    // fake.Add("/work/clas12/dilinib/SIDIS_exclusive/MC_testing/skim_DIS_pass1_671_676.hipo");
    // fake.Add("/work/clas12/dilinib/SIDIS_exclusive/MC_testing/skim_DIS_pass1_677_681.hipo");
    /* fake.Add("/work/clas12/dilinib/SIDIS_exclusive/MC_testing/skim_DIS_pass1_689_692.hipo");
     fake.Add("/work/clas12/dilinib/SIDIS_exclusive/MC_testing/skim_DIS_pass1_762_766.hipo");
     fake.Add("/work/clas12/dilinib/SIDIS_exclusive/MC_testing/skim_DIS_pass1_711_717.hipo");
     fake.Add("/work/clas12/dilinib/SIDIS_exclusive/MC_testing/skim_DIS_pass1_718_724.hipo");
     fake.Add("/work/clas12/dilinib/SIDIS_exclusive/MC_testing/skim_DIS_pass1_705_710.hipo");*/
    //  fake.Add("/lustre19/expphy/volatile/clas12/dilinib/SIDIS/MC_testing/Background_merge/skim_orlando_*");
    // fake.Add("/w/hallb-scifs17exp/clas12/dilinib/myMC/MyMC.hipo");
    ...
    for(Int_t i=0;i<files->GetEntries();i++){
        ...
        while(c12.next()==true){
                        ...
                        if((particles[i]->par()->getChi2Pid()) > -2.5 && (particles[i]->par()->getChi2Pid()) < 2.5 ){
                            if(particles[i]->getRegion()==FD){
                                if(DC_fiducial_region1_chi2 && DC_fiducial_region2_chi2 && DC_fiducial_region3_chi2){
                                    ...
                                    proton.SetPxPyPzE(px, py, pz,
                                                      sqrt(pow(pmag,2) + pow(Mp,2)));
                        ...
                        if((particles[i]->par()->getChi2Pid()) > -2.64 && (particles[i]->par()->getChi2Pid()) < 2.64 ){
                            if(particles[i]->getRegion()==FD){
                                if(DC_fiducial_region1_chi2 && DC_fiducial_region2_chi2 && DC_fiducial_region3_chi2){
                                    ...
                                    piplus.SetPxPyPzE(fpip*px,fpip* py,fpip* pz,
                                                      sqrt(pow(fpip*pmag,2) + pow(Mpi,2)));
                        ...
                        if(particles[i]->getRegion()==FD){
                            if(DC_fiducial_region1_chi2 && DC_fiducial_region2_chi2 && DC_fiducial_region3_chi2){
                                if((particles[i]->par()->getChi2Pid()) > -2.79 && (particles[i]->par()->getChi2Pid()) < 2.79 ){
                                    //DC Fiducial cuts valid
                                    piminus.SetPxPyPzE(fpim*px,fpim*py,fpim* pz,
                                                       sqrt(pow(fpim*pmag,2) + pow(Mpi,2)));
            ...
            for (int iPart=0; iPart<(int)protonmult; iPart++)
            {
                ...
                for(int jPart=0; jPart<(int)piplusmult; jPart++)
                {
                    ...
                    for(int kPart=0; kPart<(int)piplusmult; kPart++)
                    {
                        ...
                        //Looking at H(e,e' p \pi+ \pi-)X events (4 fold) for the efficiency studies
                        
                        h_efficiency_eppippimX->Fill(Miss_total.M2());
                        
                        //       h_Miss_total_momentum_fcut->Fill(Miss_total.P());
                        
                        M122=P122.M2();
                        h_MpipiSq_fcut->Fill(M122);
                        //  Now apply all exclusivity cuts
                        //Apply all exclusivity cuts
                        if(QSq > 1.0 && WSq > 4.0){
            ...
            /*
             ...
             //Computing flux factor
             double epsilon=1./1.+2.*(Q2.M2()+(beam.E()-electrontrigger.E())*(beam.E()-electrontrigger.E()))/(4*(beam.E())*(electrontrigger.E())-(Q2.M2()));
             double tau_v=Coupling_const/(8.* TMath::Pi()) * (Q2.M2())/(Mp2*(beam.E())*(beam.E())) * (1-xBj)/(xBj*xBj*xBj)* 1./(1-epsilon);
             //       printf("flux factor %f \n",tau_v);
             if(QSq > 1.0 && WSq > 4.0){
             ht->Fill(-Delta.M2());
             hW2->Fill(W2.M());
             ...
             if(Miss_total.E() > -0.6 && Miss_total.E() < 0.6){
             if(Miss_total.M2() > -0.5 && Miss_total.M2() < 0.5){
             if(yq.Dot(Miss_total.Vect())> -1 && yq.Dot(Miss_total.Vect())< 1){
             if(Rec_Track_DC_Chi2N < 20){
    ...
    TAxis *axis15 =  h_efficiency_eppipX->GetXaxis();
    int bmin15 = axis15->FindBin(-0.08); //in  case xmin=-0.8
    int bmax15 = axis15->FindBin(0.08); //in  case xmax=0.8
    double integral15=  h_efficiency_eppipX->Integral(bmin15,bmax15);
    cout<<"Integral from -0.08 to 0.08 for pim peak H(e,e' p pi+)X "<<integral15 <<endl;
